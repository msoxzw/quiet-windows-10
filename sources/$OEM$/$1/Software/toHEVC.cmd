...
for %%i in (%*) do (
	REM H.264
	:: ffmpeg -i - -map 0 -c copy -c:v libx264 -preset slower -crf 19.4 -x264-params ref=5:subme=10:fast-pskip=0:threads=%NUMBER_OF_PROCESSORS%:lookahead-threads=1 -c:a libopus -f matroska - < %%i > "%%~dpni[AVC_Opus].mkv"
	REM H.265
